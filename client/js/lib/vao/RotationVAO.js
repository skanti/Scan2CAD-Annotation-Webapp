...
import * as CircularArrow from '../geometry/CircularArrow';
...
class VAOMesh {
    constructor() {
        ...
        this.color = new THREE.Vector4(1, 0 , 0, 1.0);
    }
}
...
class RotationVAO {
    ...
    set_color_to_yellow() {
        this.vao.color.set(231/255.0, 244/255.0, 115/255.0, 1.0);
    }

    set_pos(a, b, c) {
        this.gl.useProgram(this.program);

        this.mesh = CircularArrow.make_circular_arrow(a, b, c, this.id_mesh);
        this.set_color_to_yellow();
